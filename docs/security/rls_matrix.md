...
| **`doctor_slots`** | Lecture (Disponibilités) | Gestion (Ses créneaux) | ❌ Aucun accès | Accès Total |
...
| **`prescriptions`** | Lecture & Suivi (Ses ordonnances) | Création & Signature (Ses prescriptions) | Lecture (Si transférée à son officine) | Accès Total |
